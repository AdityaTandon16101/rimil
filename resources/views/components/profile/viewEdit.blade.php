  ...
  <style>
		...
		*{
		...
		.email-label-input{
			...
			margin-top: 5px;
			border: 2px solid #085685;
			border-radius: 6px;text-align: center;font-family: serif;
			font-size: 15px;
		}
				...
				<form>
					<div class="name">
						...
						<div class="name-input">
							<input class="name-label-input" type="text" name="" placeholder="User Name" value="">
						</div>
					</div>
					...
					<div class="email">
						...
						<div class="email-input">
							<input class="email-label-input" type="text" name="" placeholder="email" value="">
						</div>
					</div>
					...
					<div class="mobileno">
						...
						<div class="mobile-input">
							<input class="mobileno-label-input" type="text" name="" placeholder="Mobile No." value="">
						</div>
					</div>

					<div class="btn">
					    <div class="edit-btn">
						    <input class="edit-btn-link" type="submit" name="" value="Edit">
					    </div>
				    </div>
				</form>
			</div>
