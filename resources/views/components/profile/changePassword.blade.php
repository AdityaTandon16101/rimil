...
<form action="{{ route('customer.changePassword', auth()->id()) }}" method="POST">
	@csrf
	@method('PUT')
				...
				<form>
					<div class="name">
						...
						<div class="name-output">
							<input class="name-label-output" type="text" name="old_password" placeholder="Old Password"
								value="">
						</div>
					</div>
					...
					<div class="email">
						...
						<div class="email-output">
							<input class="email-label-output" type="text" name="password" placeholder="New Password"
								value="">
						</div>
					</div>
					...
					<div class="idno">
						...
						<div class="idno-output">
							<input class="idno-label-output" type="text" name="confirm_password"
								placeholder="Conform Password" value="">
						</div>
					</div>
				</form>
